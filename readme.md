# Fishing detection dataset 1800 images in Yolo format with clear images and annotations.

# Body

Fishing detection dataset, 1800 images in yolo format, with clear images and complete annotations, suitable for training yolo series models, for target detection, project experiments, learning research and other scenarios. The dataset is labeled and ready to use directly.
